...
import Logo from '../assets/images/dms-logo-transparent.png'; // Make sure this path/file exists!
...
export default Footer; // <-- THIS IS CRUCIAL FOR THE IMPORT STYLE YOU WANT
